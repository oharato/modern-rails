...
| 項目 | 改善前 | 改善後 (見込み) | 削減時間 |
| :--- | :---: | :---: | :---: |
| **GHA Setup (Buildx/Gem)** | 32 秒 | ~12 秒 | 🚀 **~20 秒削減** |
| **Kamal readiness & ヘルスチェック** | 20 秒 | ~10 秒 | 🚀 **~10 秒削減** |
| **旧コンテナ停止 (`docker stop`)** | 14 秒 | ~4 秒 | 🚀 **~10 秒削減** |
| **デプロイ総所要時間** | **2分31秒 (151s)** | **約1分20秒〜1分35秒** | 🚀 **約40% 削減** |
