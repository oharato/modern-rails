...
exports.getSearchAllResourcesOutput = exports.getSearchAllResources = void 0;
 ...
 * ```
 */
function getSearchAllResources(args, opts) {
...
exports.getSearchAllResources = getSearchAllResources;
/**
 * Searches all Google Cloud resources within the specified scope, such as a project, folder, or organization. See the
 * [REST API](https://cloud.google.com/asset-inventory/docs/reference/rest/v1/TopLevel/searchAllResources)
 * for more details.
 ...
 * ```
 */
function getSearchAllResourcesOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getSearchAllResourcesOutput = getSearchAllResourcesOutput;
//# sourceMappingURL=getSearchAllResources.js.map