...
exports.getSubnetworksOutput = exports.getSubnetworks = void 0;
 ...
 * ```
 */
function getSubnetworks(args, opts) {
    args = args || {};
...
exports.getSubnetworks = getSubnetworks;
/**
 * Get subnetworks within GCE.
 * See [the official documentation](https://cloud.google.com/vpc/docs/subnets)
 * and [API](https://cloud.google.com/compute/docs/reference/rest/v1/subnetworks/list).
 ...
 * ```
 */
function getSubnetworksOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getSubnetworksOutput = getSubnetworksOutput;
