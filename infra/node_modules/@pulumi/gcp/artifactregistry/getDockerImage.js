...
exports.getDockerImageOutput = exports.getDockerImage = void 0;
 ...
 * ```
 */
function getDockerImage(args, opts) {
 ...
 * ```
 */
function getDockerImageOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getDockerImageOutput = getDockerImageOutput;
//# sourceMappingURL=getDockerImage.js.map