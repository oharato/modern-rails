...
class AppCheckRecaptchaV3Config extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new AppCheckRecaptchaV3Config(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["siteSecret"] = (args === null || args === void 0 ? void 0 : args.siteSecret) ? pulumi.secret(args.siteSecret) : undefined;
