...
async function invokeAsync(tok, props, opts, packageRef, checkDependencies) {
    ...
    try {
        ...
        if (checkDependencies) {
            ...
            if (state_1.getStore().supportsInvokeDependsOn) {
                invokeDependsOn = await dependsOn_1.getAllTransitivelyReferencedResourceURNs(resourcesToWaitFor, new Set());
            }
            else {
...
async function createInvokeRequest(tok, serialized, provider, opts, packageRef, dependsOn) {
